...
const IndexPage = () => (
  <div>
    ...
    text="Learn how to build a modern site using React and the most efficient libraries to get your
    site online. Gewt familiar with CSS grid, components, interactions, dynamic data with Contentful and deploying your
    site with Netlify"
    />
  </div>
);
